...
/// <summary>
/// A container of lexer/parser <see cref="RuleSyntax"/>.
/// </summary>
public abstract class SyntaxRuleContainer : SyntaxNode
{
    private readonly Dictionary<string, RuleSyntax> _mapRules;
    ...
    {
        _mapRules = new Dictionary<string, RuleSyntax>();
    }
    ...
    public abstract IEnumerable<RuleSyntax> GetAllRules();
    ...
    protected abstract void AddRuleImpl(RuleSyntax rule);

    private void TryAddRule(string name, RuleSyntax rule)
    {
